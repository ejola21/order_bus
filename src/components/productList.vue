<template>
  <div class="prd_list_wrap">
      ...
      <v-row class="list" v-on:click="itemSelect(product)">
        <v-col cols="4" class="list_item1">
          <lazy-component @show="handler" class="img_div">
            <v-img
              :src="product.img_thumb_url"
              :lazy-src="product.img_thumb_url"
              aspect-ratio="1.4"
            >
              <v-row
