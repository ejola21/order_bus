<template>
  <div class="n_container">
    <v-tabs fixed-tabs v-model="tab" @change="tabChange">
      <v-tab class="v_tab" href="#M">메뉴</v-tab>
      <v-tab class="v_tab" href="#R">리뷰</v-tab>
      <v-tab class="v_tab" href="#I">정보</v-tab>
    </v-tabs>
    ...
    <v-tabs-items v-model="tab">
      <v-tab-item value="M">
        <v-tabs center-active v-model="tab2">
          <v-tab
        ...
        <v-tabs-items v-model="tab2">
          ...
          >
            ...
            >
              ...
              <v-row>
                <v-col class="open_close_clock">OPEN {{ store.biz_time }}</v-col>
              </v-row>
            </v-carousel-item>
            ...
            <v-carousel-item v-if="store.coupon_yn == 'Y'" @click="couponListClick">
              <img width="100%" src="../assets/img/coupon_banner.jpg" />
            </v-carousel-item>

            <v-carousel-item v-if="time_sale_confirm.length > 0" @click="timeSaleClick">
              <img width="100%" :src="store.ban_img1" />
            </v-carousel-item>
          </v-carousel>

          <v-tab-item :value="category" v-for="(category, index) in id_list" :key="index">
        ...
        <div class="store_info" v-if="store.store_info" v-html="store.store_info" />
        <div
