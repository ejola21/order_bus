    ...
    <div class="order">
        ...
        <div class="title_name_img">
          ...
          <img :data-src='s_product.img_url' :data-error='default_img' :data-loading='default_img'>
                ...
                <div :style="{ 'background-image': 'url(' + require('../assets/img/noimg.jpg') + ')' }"
                    ...
                    <v-row no-gutters align="center" justify="space-between" class="option_cap">
                        ...
                        <v-col cols="1">
                            <v-radio-group v-model="p_o_id1">
                                ...
                                <v-radio :value="option.p_o_id" @change="radio1Change(option.p_o_val)">
                    ...
                    <v-row no-gutters align="center" justify="space-between" class="option_cap">
                        ...
                        <v-col cols="1">
                            <v-radio-group v-model="p_o_id2">
                                <v-radio :value="option.p_o_id" @change="radio2Change(option.p_o_val)">
                                </v-radio>
                            </v-radio-group>
                        </v-col>
        ...
        <div class="memo_background"
            ...
            <v-card class="demo-paper memo_window" :zDepth="1">
                <v-text-field ref="textField" v-model="u_price" type="tel" hintTextClass="u_price_hint" inputClass="u_price"
                    :errorText="minPriceError" hintText="주문 금액 1000원 이상" @input="priceChange()" icon="edit" />
            </v-card>
        ...
        <div v-if="s_product.img_url2" :style="{ 'background-image': 'url(' + require('../assets/img/noimg.jpg') + ')' }"
            style="background-size: 100% 100%">
            <lazy-component>
        ...
        <v-row no-gutters v-else>
            ...
            <v-col cols="6">
                ...
                <v-btn class="btn_basket_move" color="primary" width="100%" x-large v-on:click="payClick()">{{ select
                }}</v-btn>
            </v-col>
