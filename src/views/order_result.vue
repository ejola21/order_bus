<template>
    <div class="order_result_container" :style="{ maxHeight : windowHeight , minHeight: windowHeight}">
        <div class="order_result_title">
            <div class="order_title_img">
                <img src="../assets/img/order_success.png">
            </div>
            <div class="order_title_desc">
                <span>주문이 완료 되었습니다.</span><br>
                <span>주문 현황에서 주문상태를 볼 수 있습니다.</span><br/>
        ...
        <div class="orderResult_btns">
          ...
          <v-col class="text-center" cols="12" sm="4">
           <div class="my-2">
             ...
             <v-btn x-large color="primary" class="order_result_status_go_btn" @click="go_status_click">주문 상태 보기</v-btn>
             <v-btn x-large color="#ffffff" class="order_result_menu_go_btn" @click="go_menu_click">메뉴 더 보기</v-btn>
          <!-- <div v-if="store.group_code" class="group_store_go" @click="go_group_click">상점으로 가기</div>
          <div class="order_result_status_go_btn" @click="go_status_click">주문 상태 보기</div>
...
.order_result_menu_go_btn, .order_result_status_go_btn, .group_store_go {
    margin: .7rem 0;
    text-align: center;
    line-height: 80px;
    width: 100%;
