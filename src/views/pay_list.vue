<template>
  <v-content>
    <div class="sub_top">
      <div class="back_btn">
        <a href="javascript:void(0);"><v-icon>mdi-arrow-left</v-icon></a>
      </div>
...
export default {
  ...
  methods: {
    move_status() {
      ...
      else this.$router.push("/basket_all");
    },
...
.rv_list .list_con .con_box {
  float: left;
  width: 78%;
  padding: 1rem;
  border-right: 1px solid #ccc;
}
.rv_list .list_con .con_box .left {
  float: left;
  width: 70%;
}
.rv_list .list_con .con_box .left .name {
  font-size: 1rem;
  margin-bottom: 0.4rem;
}
.rv_list .list_con .con_box .left span {
  font-size: 0.9rem;
}
.rv_list .list_con .con_box .right {
  float: right;
  width: 25%;
  height: 100%;
}
.rv_list .list_con .con_box .right .fin {
  font-size: 1rem;
  text-align: right;
  font-weight: bold;
}
.rv_list .list_con .con_box .right .fin span {
  color: #b71c1c;
}
.rv_list .list_con .review_btn {
  float: right;
  width: 22%;
  padding: 1rem 0;
}
.rv_list .list_con .review_btn .v-btn {
  width: 80%;
  margin: 0 auto;
  display: block;
}
