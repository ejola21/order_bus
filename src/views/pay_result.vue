        ...
        <v-col class="text-center" cols="12" sm="4">
          <div class="my-2">
            <v-btn
              x-large
              color="#043474"
              v-if="store.group_code"
              class="group_store_go"
              @click="go_group_click"
              >상점으로 가기</v-btn
            >
            <v-btn
              x-large
              color="#043474"
              class="pay_result_status_go_btn"
            ...
            <v-btn
              x-large
              color="#ffffff"
              class="pay_result_menu_go_btn"
              @click="go_menu_click"
              >메뉴 더 보기</v-btn
            >
            <!-- <div v-if="store.group_code" class="group_store_go" @click="go_group_click">상점으로 가기</div>
          <div class="pay_result_status_go_btn" @click="go_status_click">예약 상태 보기</div>
        ...
        <v-col class="text-center" cols="12" sm="4">
          <div class="my-2">
            <v-btn
              x-large
              color="#474747"
              class="pay_result_basket_go_btn"
              @click="go_basket"
              >장바구니 이동</v-btn
            >
